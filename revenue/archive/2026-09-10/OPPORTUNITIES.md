...
## September 10 maintenance checkpoint

No ranking or price changes. The custom-host script/CSP blocker is resolved,
and IndexNow accepted the bounded submission. These are operational outcomes,
not evidence of indexing, visitors or purchases. The only observed browser
tracker event this session was a synthetic verification pageview. Paid-product
gates remain separate; remaining dependency work is publication-blocked.
