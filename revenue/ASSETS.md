...
- **`launch/distribution/`:** dev.to publisher (3 articles, canonical→eolkits.com), fast-cash Upwork/Fiverr/re:Post playbook, X threads, value-first email kit, video scripts.
