...
If you'd rather have this run against your actual account instead of reading it, the free **[EOLkits scanner](https://eolkits.com/scan)** checks in about 30 seconds, nothing uploaded — I maintain it, disclosing that plainly since it's the one link in this piece that isn't a fix.
