...
Batches 3–6 are preserved as research only. Their thread state and technical
claims were not verified against live primary pages in this workspace. They
must remain unsent until a fresh fact/thread review and explicit owner approval.
No autonomous agent may post these answers or contact their authors.

Targets and answers in every batch are stale or unverified and require fresh
manual policy, thread-state, and primary-source review. Nothing in this file is
approved for reuse or contact.

**Recovery note (2026-08-26):** Batches 3–5 (211 lines, three cycles of drafted work) were silently dropped
...
# Archived answer research

Each item below was drafted against a public question. It is retained only as
research provenance. Do not infer current thread state, technical accuracy,
platform-policy compliance, or permission to contact anyone from its presence.

**Historical drafting context (non-authoritative):** These drafts were originally
written to lead with a substantive answer, disclose the maintainer relationship,
avoid duplicate self-promotion, and cite AWS primary sources. Their link-status
notes and technical claims describe past observations only; none are current
instructions or evidence of present availability.

---

## 1 — AWS re:Post: "Amazon Linux 2 End of Life Migration"
**Archived research target:** https://repost.aws/questions/QUjhyVpUEPShyFSWrWT3mICw/amazon-linux-2-end-of-life-migration
...
**Archived research target:** https://repost.aws/questions/QUwvZZcO78S2iFe9UF6rK4nw/aws-lambda-python-runtime-3-9-eol
...
**Archived research target:** https://repost.aws/questions/QU8_7ivy19Q7Wq3CKUE5b7Jw/amazon-linux-2-motd-says-eol-is-2025-06-30
...
## Archived research leads — do not contact

- Historical search terms: `[amazon-linux] end of life`, `nodejs20.x lambda deprecated`, `No module named 'distutils' lambda`
- Historical AWS re:Post tag: https://repost.aws/tags/questions/TAl4y_oRX1RjmpJJGVndhKtA (Amazon Linux)
- These leads were never revalidated or approved for outreach.

---

# Batch 3 — UNVERIFIED DRAFT, DO NOT POST (drafted 2026-08-23)

Found via historical search; not duplicates of Batches 1–2. The notes below
record the sources and deployment state observed on the drafting date. AWS has
revised runtime block dates more than once, and neither the claims, thread state,
nor link destinations have been revalidated. Domain-selection notes are retained
only as provenance and do not authorize reuse or contact.

## 1 — [Action Required] AWS Lambda end of support for Node.js 18 - referenced functions no longer exist

Archived research target: https://repost.aws/questions/QUz3FDy7jfQliBFrh_hKZoaQ/action-required-aws-lambda-end-of-support-for-node-js-18-referenced-functions-no-longer-exist
...
Archived research target: https://repost.aws/questions/QUqvfJVhQ4ReeApG8shtcu1A/how-can-i-use-amazon-linux-2023-for-aws-codebuild-runner-projects-still-getting-al2
...
# Batch 4 — UNVERIFIED DRAFT, DO NOT POST (drafted 2026-08-24)

Found via historical search; not a duplicate of Batches 1–3. Direct page fetch
was unavailable on the drafting date (`EGRESS_BLOCKED`), so the draft relied on
search-result excerpts plus AWS runtime-management documentation. That is weak
provenance, not a current verification. The thread, claims, and destination link
must be treated as stale research with no authorization for reuse or contact.

## 1 — python 3.9 runtime update gives Runtime.Unknown in INIT phase

Archived research target: https://repost.aws/questions/QUowJJh-50R3KbxGrZ2YNsCA/python-3-9-runtime-update-gives-runtime-unknown-in-init-phase
...
# Batch 5 — UNVERIFIED DRAFT, DO NOT POST (drafted 2026-08-25)

Found via historical search; not a duplicate of Batches 1–4. Direct page fetch
was unavailable on the drafting date (`EGRESS_BLOCKED`), so the draft relied on
search-result excerpts and a then-current AWS runtimes table. The dated runtime
values, thread state, and destination link are retained only as provenance. They
are not current evidence and do not authorize reuse or contact.

## 1 — API GATEWAY DEV PORTAL - Update Lambda Functions to nodejs20

Archived research target: https://repost.aws/questions/QURnP8vskJREG40Ilrwx_RLQ/api-gateway-dev-portal-update-lambda-functions-to-nodejs20
...
# Batch 6 — UNVERIFIED DRAFT, DO NOT POST (drafted 2026-08-26)

Found via historical search; not a duplicate of Batches 1–5. Direct page fetch
was unavailable on the drafting date (`EGRESS_BLOCKED`), so the draft relied on
search-result excerpts from several sources rather than a page fetch. The thread,
claims, and runtime dates are unverified historical research, not a source of
truth or authorization for reuse or contact.
...
Archived research target: https://repost.aws/questions/QUVhoUXEhDSBGXtsiU8xCpIA/the-runtime-parameter-of-nodejs14-x-is-no-longer-supported-for-creating-or-updating-aws-lambda-functions-we-recommend-you-use-the-new-runtime-nodejs20-x
