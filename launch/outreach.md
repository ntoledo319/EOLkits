...
```
Subject: EOLkits is live — want me to run it on [repo / your stack]?
...
```
Subject: EOLkits PR merged in [repo] — quick favor?

[name],

Saw [repo] merged the eolkits-bot PR. That's the first real-world end-to-end I've shipped on this thing — massive thanks for taking the leap.
...
2. If the migration went clean and CI's still green a week from now, would you be okay with me linking [repo / company] on the EOLkits launch page as a real-world install? Just "Used in production at [company]" with a link. Happy to draft the line and run it past you before it goes live. If you'd rather skip the public credit, no follow-up — the PR itself was the gift.
